...
| ---------------- | ----------------- | ---------------- | ---------------- |
| [`nmap!`](#nmap) | [`vmap!`](#vmap)  | [`xmap!`](#xmap) | [`smap!`](#smap) |

| Operator-pending `o` | Insert `i`       | Lang-Arg `l`     | Command-line     | Terminal         |
| -------------------- | ---------------- | ---------------- | ---------------- | ---------------- |
| [`omap!`](#omap)     | [`imap!`](#imap) | [`lmap!`](#lmap) | [`cmap!`](#cmap) | [`tmap!`](#tmap) |

| All                    | Input `!`/`ic`             | Motion `nvo`/`nxo`           | Range `nx`                 | Textobj `xo`                   |
| ---------------------- | -------------------------- | ---------------------------- | -------------------------- | ------------------------------ |
| [`map-all!`](#map-all) | [`map-input!`](#map-input) | [`map-motion!`](#map-motion) | [`map-range!`](#map-range) | [`map-textobj!`](#map-textobj) |
