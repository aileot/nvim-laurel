 ...
 local function command_2f__3ecompatible_opts_21(opts) _G.assert((nil ~= opts), "Missing argument opts on fnl/nvim-laurel/utils.fnl:14")
 opts.buffer = nil
 opts["<buffer>"] = nil
 return opts end

 local function autocmd_2f__3ecompatible_opts_21(opts) _G.assert((nil ~= opts), "Missing argument opts on fnl/nvim-laurel/utils.fnl:19")
 opts["<buffer>"] = nil
 opts["<command>"] = nil
 opts.ex = nil
 return opts end
